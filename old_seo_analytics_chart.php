...
-->
				...
				<!-- New row end -->
					...
					<div class="col-md-12">
						<div class="panel panel-default panel-stacked panel-hovered mb30">
							<div class="panel-heading inner-dash-heading text-right">
								<h2 class="text-center performance">Monthly Performance Report - <?php echo date('F, Y')?><small>(<?php echo $domain_details['domain_url'];?>)</small><br/>
									<?php
									/* if(!empty($data)) { ?>
                                ...
                                <div class="about-comp-btn pull-right">
										...
										?>
											<a href="#" data-hover="tooltip" data-pageid="edit_note_first" title="" data-row="summernote" data-id="<?php echo $checkEditNotes0['id']; ?>" class="delete_edit_notes" data-placement="left" data-original-title="Delete">
                            ...
                            <div class="pd-fixed-bar">
                                ...
                                <div class="pd-bar-data" >
                                    ...
                                    <big class="traffic_growth">0 <span id="traffic_growth" class="green">0%</span></big><strong>Traffic</strong>
                                    </a>
                                </div>
                                <div class="pd-bar-data" >
                                ...
                                <div class="pd-bar-data" >
                                    ...
                                    <big class="google_analytics"><?php echo $checkCurrentGoogleGoal['total']; ?> <span ><?php echo  number_format($goal_result, 2, '.', ''); ?></span></big><strong>Goals</strong></a>
                                </div>
                    ...
                    <div class="chart-loader"  id="chart_1"> <img src="<?php echo 'assets/images/squares.gif'; ?>" /></div>
									...
									<div class="col-md-6">
										...
										<h2>Organic Traffic Growth (6 months)

										<!--<a href="#" id="key_word" class="waves-effect">authorize google account</a> -->
										...
										/* if(empty($googleAnalytics['property_id'])) { ?>
											<div class="modal-body">
												<div class="select-view-cover">
													<div id="" class="chart"> Please Provide Google Analytics Account Detail.</div>
												</div>
											</div>
										<?php } else if(!empty($googleAnalytics['property_id']) && $googleAnalytics['property_id'] == 'false') { ?>
											<div class="modal-body">
												<div class="select-view-cover">
													<div id="" class="chart"> User does not have analytics account.</div>
												</div>
											</div>
										<?php } */
										?>
							...
							<div class="panel-heading">
                                <h2>Organic Keywords
									<div class="about-comp-btn pull-right">
										...
										?>
											<a href="#" data-hover="tooltip" data-pageid="edit_note_second" title="" data-row="summernote1" data-id="<?php echo $checkEditNotes1['id']; ?>" class="delete_edit_notes" data-placement="left" data-original-title="Delete">
												<i class="fa fa-trash-o" aria-hidden="true"></i>
											</a>
										<?php } ?>
									</div>
					...
					<div class="col-md-12">
						<div class="panel panel-default panel-lined table-responsive panel-hovered mb20 data-table" style="padding-bottom: 20px">
							<div class="panel-heading">
                                <h2>Sample Backlinks
									<div class="about-comp-btn pull-right">
										<a href="#" data-hover="tooltip" id="backlink_edit_note" title="" data-placement="left" data-original-title="Edit">
											<i class="fa fa-pencil"></i>
										</a>
										<?php
											if(!empty($checkEditNotes2)) {
										?>
											<a href="#" data-hover="tooltip" data-pageid="edit_note_third" data-row="summernote2" title="" data-id="<?php echo $checkEditNotes2['id']; ?>" class="delete_edit_notes" data-placement="left" data-original-title="Delete">
												<i class="fa fa-trash-o" aria-hidden="true"></i>
											</a>
										<?php } ?>
									</div>
													...
													<td><div><?php echo $record['source_title']?></div>
														...
														<?php /* if(strpos($record['lostlink'],'true') !== false) { ?>
															<div class="ba-table__labels">
																<span data-js-tooltip-name="lostlink" class="s-label -danger -xxs ba-widget__tooltip-trigger">
																	<span data-test-lostlink="" class="s-label__text" data-hover="tooltip" title="Lost on <?php echo date('M d, Y', $record['last_seen'])?>. A lost backlink is displayed in the report for 3 months after the date that SEMrush couldn’t find it.">lost</span>
																	<div class="ba-widget__tooltip -bottom-left" style="margin-left: -7px;">
															...
															<div class="ba-table__labels">
																<span data-js-tooltip-name="newlink" class="s-label -success -xxs ba-widget__tooltip-trigger">
																	<span data-test-newlink="" class="s-label__text" data-hover="tooltip" title="Found on <?php echo date('M d, Y', $record['first_seen'])?>. A backlink is considered to be new if less than a month has passed since the date that SEMrush first discovered it.">new</span>
																	<div class="ba-widget__tooltip -bottom-left" style="margin-left: -7px;">
					...
					<!-- Google Analytics Goal -->
							...
							<div class="panel panel-default panel-stacked panel-hovered mb30">
								<div class="panel-heading">
									<h2>Google Analytics Goal Completion
										...
										?>
											<a href="#" data-hover="tooltip" data-pageid="edit_note_fourth" title="" data-row="summernote3" data-id="<?php echo $checkEditNotes3['id']; ?>" class="delete_edit_notes" data-placement="left" data-original-title="Delete">
												<i class="fa fa-trash-o" aria-hidden="true"></i>
											</a>
										<?php } ?>
										</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default panel-stacked panel-hovered mb30 edit-notes-section">
								<div class="panel-heading">
									<h2><span class="notes_heading"><?php echo ($checkEditNotes4['note_heading'] != '' ? $checkEditNotes4['note_heading'] : 'Notes'); ?></span>
										<div id="heading_input_field" style="display:none"> Heading : <input type="text" name="notes_value" id="notes_value" value="<?php echo ($checkEditNotes4['note_heading'] != '' ? $checkEditNotes4['note_heading'] : 'Notes'); ?>"> </div>
										...
										?>
											<a href="#" data-hover="tooltip" data-pageid="edit_note_fifth"  title="" data-row="summernote4" data-id="<?php echo $checkEditNotes4['id']; ?>" class="delete_edit_notes" data-placement="left" data-original-title="Delete">
												<i class="fa fa-trash-o" aria-hidden="true"></i>
											</a>
										<?php } ?>
										</div>
								...
								<?php
									if(!empty($checkEditNotes4)) {
								?>
									<div class="panel-body edit_note_fifth"><?php echo $checkEditNotes4['edit_section']; ?></div>
								<?php
									}
								?>
							</div>
	...
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.2/css/bootstrap-select.min.css"></link>
	<style type="text/css">
		.bs-example{
		margin: 20px;
		}
	...
	<script type="text/javascript">
		...
		$(function () {
			Highcharts.chart('keyword_range', {
				chart: {
   ...
   viewSelector.set({
	...
	dataChart1.on('success', function(records) {
		...
		jQuery.ajax({
			...
			data:	{action: 'session_response', view_id: data_id_key, request_id: request_id_key, rows: response},
			dataType: 'json',
	...
	dataChart2.on('success', function(records) {
		...
		jQuery.ajax({
			type:	'POST',
			url: 	"assets/ajax/ajax_session_response.php",
			data:	{action: 'goal_completions_last', view_id: data_id_key, request_id: request_id_key, rows: response},
			dataType: 'json',
			success: function(result) {
	...
	report.on('success', function(response) {
		...
		if($('.users_new').val() <= 0 || $('.users_old').val() <= 0) {
			...
			var total_users		=	(($('.users_new').val() -  $('.users_old').val()) /  $('.users_old').val() * 100).toFixed(2)+'%';
		}
		...
		if( $('.session_new').val() <=0 || $('.session_old').val() <=0  )   {
			...
			var total_session		=	(($('.session_new').val() - $('.session_old').val()) / $('.session_old').val() * 100).toFixed(2)+'%';
		}
		...
		var traffic_growth 			=	$('.session_new').val()+' <span id="traffic_growth" class="'+traffic_growth_class+'">'+total_session+'</span>';


		if($('.pageview_new').val() <=0 || $('.pageview_old').val() <=0) {
			var total_pageview		=	"100%";
		}else{
			var total_pageview 		=	(($('.pageview_new').val() - $('.pageview_old').val()) / $('.pageview_old').val() * 100).toFixed(2)+'%';
		}
		...
		jQuery.ajax({
			type:	'POST',
			url: 	"assets/ajax/ajax_session_response.php",
			data:	{action: 'old_vs_new', view_id: data_id_key, request_id: request_id_key, session_old: session_old, session_new: session_new, total_session: total_session, users_new: users_new, users_old: users_old, total_users: total_users, pageview_new: pageview_new, pageview_old: pageview_old, total_pageview: total_pageview },
			dataType: 'json',
			success: function(result) {
	...
	*/
	...
	dataChart4.on('success', function(response3) {
		...
		jQuery.ajax({
			type:	'POST',
			url: 	"assets/ajax/ajax_session_response.php",
			data:	{action: 'session_data', view_id: data_id_key, request_id: request_id_key, rows: response},
			dataType: 'json',
			success: function(result) {
				...
				if(isNaN(total_google)){
					...
					//console.log(total_google);
					total_google	=	'<span id="traffic_growth" class="green">100%</span>';
				}else{
					//console.log(total_google);
					if(isNaN(increased) || increased <= 0) {
					...
					total_google	=	result['goal_count']+' <span id="goal_count_old" class="'+google_growth_class+'">'+total_google.toFixed(2)+'% </span>';
				}
				//console.log(total_google);
	...
	viewSelector.on('change', function (ids) {
		...
		jQuery.ajax({
			...
			data:	{action: 'update_google_view_id', view_id:	data_id, request_id: request_id},
			dataType: 'json',
			success: function(result) {
				var status	=	result['status'];
				var analytic_id	=	result['analytic_id'];
...
$(document).on("change", ".onchange", function(){
	...
	jQuery.ajax({
		...
		data:	{action: 'update_select_div', request_id: '<?php echo $_REQUEST['id']?>', analytic_id: data_id},
		success: function(result) {
			console.log(result);
...
$(document).on("click", "#saveAbout", function () {
	...
	$.ajax({
	  ...
	  data:    {action: 'email_data', share_id: requestId, content_text: sHTML, edit_section: '0'},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
...
$(document).on("click", "#save_bottom", function () {
	...
	$.ajax({
	  ...
	  type:    "POST",
	  url:     "assets/ajax/ajax-save-text.php",
	  data:    {action: 'email_data', share_id: requestId, content_text: sHTML, edit_section: '4', note_heading: notes},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
...
$(document).on("click", "#organic_save_note", function () {
	...
	$.ajax({
	  ...
	  type:    "POST",
	  url:     "assets/ajax/ajax-save-text.php",
	  data:    {action: 'email_data', share_id: requestId, content_text: sHTML, edit_section: '1'},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
...
$(document).on("click", "#backlink_save_note", function () {
	...
	$.ajax({
	  ...
	  type:    "POST",
	  url:     "assets/ajax/ajax-save-text.php",
	  data:    {action: 'email_data', share_id: requestId, content_text: sHTML, edit_section: '2'},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
...
$(document).on("click", "#goal_save_note", function () {
	...
	$.ajax({
	  ...
	  type:    "POST",
	  url:     "assets/ajax/ajax-save-text.php",
	  data:    {action: 'email_data', share_id: requestId, content_text: sHTML, edit_section: '3'},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
...
$(document).on("click", ".delete_edit_notes", function (e) {
	...
	$.ajax({
	  ...
	  type:    "POST",
	  url:     "assets/ajax/ajax-save-text.php",
	  data:    {action: 'remove_edit_data', request_id: requestId},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
...
$(document).on("click", "#update_semrush_data", function (e) {
	...
	$.ajax({
	  ...
	  data:    {action: 'update_semerush_data', request_id: requestId, input_id: input_id},
	  success: function(result) {
		var status	=	result['status'];
		if(status == 'success'){
			location.reload();
        ...
        <div class="modal-content" style="height:400px !important">
            ...
            <div class="modal-header">
				...
				<div class="add-new-acc-btn">
					<a href="<?php echo FULL_PATH ?>/auth_analytics.php?ids=<?php echo $_REQUEST['id']?>">Add New Account </a>
				</div>
				<div class="select-view-cover">
					<!--<h1 class="Titles-main" id="view-name">Select a View</h1>
					<div id="view-selector" class="chart"></div>-->

						<select class="select onchange selectpicker" id="google_account" data-live-search="true" data-dropup-auto="false" >
							<optgroup>
							<option value="">Please Select</option>
							<?php
								foreach($google_account as $account) {
							?>
								<option value="<?php echo $account['id'];?>" <?php if($account['id'] == $googleAnalytics['id']) echo 'selected'; ?>><?php echo $account['email'] ?></option>
							<?php }?>
							</optgroup>
						</select>
				</div>
				<?php } else {?>
				<a href="<?php echo FULL_PATH ?>/auth_google.php?ids=<?php echo $_REQUEST['id'];?>">Click here to  Authorize of Google Anayltics Account </a>
				<?php } ?>
				<div class="clearfix"></div>
            </div>
					...
					<div id="view-selector" class="chart">
						<select name="analytic_account" id="analytic_account" class="selectpicker" data-live-search="true" data-dropup-auto="false" data-id="<?php echo $_REQUEST['id']; ?>">
							...
							<?php foreach($googleViewSelector as $viewSelector) { ?>
								<option value="<?php echo $viewSelector['id']?>"
									<?php
										if(!empty($googleAnalytics['id'])) {
						...
						<select name="analytic_property" id="analytic_property">
							...
							?>
							<option value="<?php echo $property_field['id']?>" <?php echo ($googleAnalytics['google_property_id'] == $property_field['id'] ? 'selected' : ''); ?>><?php echo $property_field['category_name'];?></option>
							<?php
									}
						...
						<select name="analytic_view_id" id="analytic_view_id">
							...
							?>
<option value="<?php echo $profile_field['category_id']?>" <?php echo ($googleAnalytics['property_id'] == $profile_field['category_id'] ? 'selected' : ''); ?>><?php echo $profile_field['category_name'];?></option>
							<?php
									}
				...
				<div class="select_box_loader" style="display:none;"><div class="loader-msg">Please wait it will take maximum 60 seconds</div><img src="<?php echo 'assets/images/squares.gif'; ?>" /></div>
            </div>
