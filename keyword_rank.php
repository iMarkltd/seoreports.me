...
function _in_logit_POST($id_message, $data) {
	echo __DIR__."/postback_url_example.txt";
	file_put_contents("postback_url_example.txt", "Hello World. Testing!");	
	@file_put_contents(__DIR__."/postback_url_example.txt", PHP_EOL.date("Y-m-d H:i:s").": ".$id_message.PHP_EOL."---------".PHP_EOL.print_r($data, true).PHP_EOL."---------", FILE_APPEND);
}
