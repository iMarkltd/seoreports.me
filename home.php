							...
							<div class="panel panel-default mb20 panel-hovered project-stats table-responsive">
								<div class="panel-heading with-upgrade-btn">
                                   <div class="panel-heading-data text-capitalize">
                                    Monthly Performance Reports - SEO
                                    </div>
                                     <div class="panel-heading-data right-side">
                                <a class="btn btn-line-success btn-rounded waves-effect "><i class="fa fa-arrow-circle-up"></i> Upgrade</a>
                                <a class="btn btn-line-success btn-rounded waves-effect " id="add_domain"><i class="fa fa-arrow-circle-up"></i> Add New Project</a>
                                    </div>
                                </div>
                                <div id="home_loader">
...
$(document).ready(function() {
  ...
  $('#example').DataTable();
	jQuery.ajax({
	  action:  'personal',
	  type:    "POST",
	  url:     "assets/ajax/ajax-categories.php",
